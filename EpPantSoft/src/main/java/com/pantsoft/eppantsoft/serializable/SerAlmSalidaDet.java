...
public class SerAlmSalidaDet {
	...
	public SerAlmSalidaDet(String empresa, long folioAlmSalida, String almacen, String modelo, String color, String talla, String codigoDeBarras, Date fechaAlmSalida, long dia, long mes, long anio, long cantidad) {
		setEmpresa(empresa);
