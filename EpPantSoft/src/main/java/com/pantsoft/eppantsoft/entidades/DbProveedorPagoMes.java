...
public class DbProveedorPagoMes extends ClsEntidad {
	...
	public List<ClsCampo> getCampos() {
		return Arrays.asList(empresa, mes, autorizado1, autorizado2, autorizado3, autorizado4, autorizado5, terminado);
	}

	public SerProveedorPagoMes toSerProveedorPagoMes() throws ExcepcionControlada {
		return new SerProveedorPagoMes(getEmpresa(), getMes(), getAutorizado1(), getAutorizado2(), getAutorizado3(), getAutorizado4(), getAutorizado5(), getTerminado());
	}
